...
const BOOKINGS = [
  ...
  {when:'~IV 2027', what:'Miejscówki kolejowe', note:'NEX + shinkansen do Kioto (29.04), Kioto→Tokio (3.05, święto!), Odawara→Tokio + NEX (7.05). W Golden Week bez miejscówek nie ma miejsc — kupić w SmartEX.'},
