...
const BOOKINGS = [
  ...
  {when:'IX–X 2026', what:'Rezerwacja MIMARU Tokyo AKASAKA (3–6.05)', note:'Hotel wybrany 8.09 zamiast Ueno EAST — z Akasaki Harajuku, Shinjuku i Nihombashi są bez przesiadki. Apartament 40 m² dla 4 osób, pralnia samoobsługowa na miejscu. CENĘ TRZEBA POTWIERDZIĆ — w budżecie stoi założenie 3 800 zł za 3 noce.'},
  {when:'II–III 2027', what:'Prywatna kąpiel w Hanaori (6.05)', note:'Dwie kashikiri na cały obiekt — rezerwować z góry, bo duże łaźnie są rozdzielone płciowo i 13-latek idzie do męskiej sam. Recepcja +81 460-83-8739, 10:00–18:00. Ceny nie podają online. Tatuaż = tylko prywatna.'},
...
{date:'2027-05-03',dow:'poniedziałek',dd:'3 maja',city:'tokio',title:'Shinkansen do Tokio i wieczorna Asakusa',
 ...
 tl:[
  ...
  ['12:30','Tokyo Station → Akasaka: bagaże do przechowalni','Metro Marunouchi, ~10 min. Zameldowanie w MIMARU zaczyna się o 15:00 — o tej porze tylko zostawiacie bagaże w recepcji (hotel przechowuje w dniu przyjazdu) i idziecie na lunch.'],
  ['14:00','Asakusa','Brama Kaminarimon i deptak Nakamise — w święto tłoczno jak w niedzielę; idźcie bocznymi uliczkami (Denbōin-dōri), a główny deptak zostawcie na wieczór.'],
  ['18:00','Sensō-ji o zmroku','Podświetlona pagoda, gdy stragany się zwijają.'],
  ['19:00','Kolacja','Ramen albo izakaya w Asakusie.'],
  ['20:30','Zameldowanie w MIMARU Akasaka','Ginza Line z Asakusy prosto do Tameike-sannō, ~25 min bez przesiadki; bagaże czekają w recepcji.'],
 ],
...
{date:'2027-05-05',dow:'środa',dd:'5 maja',city:'tokio',title:'Dzień Dziecka: karpie koinobori, Pokémony i Akihabara',
 ...
 tl:[
  ...
  ['16:30','Akihabara — opcjonalnie','Elektryczne miasteczko: gachapony, salony gier retro, sklepy z anime i elektroniką. To zawór dnia: jeśli po Pokémonach nikt nie ma siły, wracajcie do Akasaki — Ginza Line jedzie tam bez przesiadki.'],
...
{date:'2027-05-06',dow:'czwartek',dd:'6 maja',city:'hakone',title:'Pętla Hakone i noc nad jeziorem',
 ...
 tl:[
  ...
  ['15:00','Zameldowanie i prywatna kąpiel','Hanaori ma dwie duże łaźnie (jedna z widokiem na ogród, druga na jezioro) i do tego <b>dwie prywatne półotwarte kąpiele do wynajęcia</b> — i to te drugie rezerwujemy na dziś. Powód jest prosty: duże łaźnie są rozdzielone na panów i panie, a 13-latek idzie już do męskiej strony wśród obcych i nago. W prywatnej wchodzicie we czworo. To jest punkt dnia — tu świadomie niczego już nie zaliczamy.'],
  ...
  ['18:30','Kolacja w ryokanie','Bufet w cenie razem ze śniadaniem. Wieczorem duże łaźnie dla chętnych — czynne do północy, a po prywatnej kąpieli wejście do nich jest już mniej onieśmielające.'],
 ],
 facts:[['Średnia','Intensywność'],['Romancecar + kolejki','Przejazdy'],['Umiarkowane','Chodzenie'],['Frajda z kolejek','Dla dzieci'],['Ryokan','Nocleg']],
 tips:['Tsukiji wypadło z planu: pobudka 6:30 po wieczorze z praniem i pakowaniem to nie był dobry pomysł, a targ dla mamy jest w Kiocie — Nishiki 2.05 po południu.','Fudżi najczęściej widać rano — trzymajcie kciuki przy porannej kolejce linowej i na jeziorze.','Prywatną kąpiel zarezerwujcie z góry — są tylko dwie na cały obiekt. Ceny ani długości sesji Hanaori nie podaje w internecie; recepcja odbiera pod +81 460-83-8739 (10:00–18:00). To także jedyna opcja, jeśli ktoś ma tatuaż — do dużych łaźni z tatuażem nie wpuszczają.','Cała pętla — kolejka zębata, linowa, Ōwakudani, statek — z podręcznymi jest do zrobienia, ale jeśli chcecie mieć wolne ręce, przy dworcu Hakone-Yumoto oddacie bagaż do 12:30 i znajdziecie go w ryokanie po 15:00 (~800–1 100 ¥/szt.). Jesteście w Yumoto o 11:25, więc zdążycie.'],
...
{id:'tokio1',name:'MIMARU Tokyo AKASAKA',stay:'Tokio · 3 noce (3–6.05)',
 ...
 price:'zakładamy ~3 800 zł za 3 noce — cenę potwierdźcie przy rezerwacji (IX–X 2026)',near:'metro Akasaka (Chiyoda) 4 min pieszo; Akasaka-mitsuke i Tameike-sannō w zasięgu spaceru',
...
function indexPage(){
  ...
  const quick = `<div class="lines">
    ...
    <a class="line" href="koszty.html"><b>Budżet</b><span>Kalkulator kosztów i zweryfikowane taryfy kolejowe — ~41 tys. zł.</span></a>
...
function hotelePage(){
  ...
  <section>
    <div class="card"><ul class="tips">
      ...
      <li>Ryokan w Hakone: Hanaori nad jeziorem Ashi, pokój Standard dla 4 osób z kolacją i śniadaniem — zostały 3 pokoje — stan z 7.09.2026, darmowe anulowanie.</li>
