...
{date:'2027-05-04',dow:'wtorek',dd:'4 maja',city:'tokio',title:'Meiji, streetwear na Cat Street i zachód słońca nad Shibuyą',
 ...
 tl:[
  ['08:45','Meiji Jingū','Chram w środku 70-hektarowego lasu w sercu miasta. Dzień Zieleni to święto, więc będzie odświętnie i ludno — dlatego jesteśmy tu przed 9:00, zanim ruszy fala (Yamanote z Ueno ~30 min, wyjście z hotelu 8:10); bywa, że trafia się na tradycyjny ślub shintō. Dla mamy opcjonalnie Muzeum Meiji Jingū na terenie chramu (budynek Kengo Kumy, ~30 min, ~1 000 ¥).'],
